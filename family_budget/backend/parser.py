            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        f"CRITICAL FOR INSTALLMENT PAYMENTS (תשלומים):\n"
                        f"- Israeli CC statements show TWO amounts: 'סכום חיוב' (charge amount) and 'סכום עסקה מקורי' (original amount)\n"
                        f"- ALWAYS use the SMALLER amount which is the 'סכום חיוב' - the actual monthly charge\n"
                        f"- The larger 'סכום עסקה מקורי' is the full original purchase price - DO NOT use this\n"
                        f"- Example: '78 ₪ 780 ₪' means charge is 78, use 78 NOT 780\n\n"
                        f"RULES:\n"
                        ...
                        f"3. amount must be a positive number (no currency symbols) - use the CHARGE amount not original\n"
